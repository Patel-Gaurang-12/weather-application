...
async function charge(name) {
	...
	await fetch('https://yahoo-weather5.p.rapidapi.com/weather?location=' + name + '&format=json&u=c', {
		method: 'GET',	
		headers: {
			'X-RapidAPI-Key': 'b3efe5c804mshcd16ae5c6e3143ap1ad18ejsn90756071c0f8',
...
function actionValue(data) {
	...
	document.getElementById("app-temp").insertAdjacentHTML("beforeend", " °C");
	document.getElementById("app-humi").insertAdjacentHTML("beforeend", " %");
	document.getElementById("app-pre").insertAdjacentHTML("beforeend", " mb");
	document.getElementById("app-direction").insertAdjacentHTML("beforeend", "°");
	document.getElementById("app-speed").insertAdjacentHTML("beforeend", " km/hr");
